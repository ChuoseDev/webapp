...
const Card01 = () => {
    ...
    return <button style={cardStyle} onClick={() => {
        ...
        <div id='cardnumber' style={cardNumberStyle}>01</div>
        ...
        <div style={infoStyle}>
            การสรุปภาพรวมโดยไม่มีหลักฐาน หรือ มีหลักฐานเพียงเล็กน้อย เช่น เมื่อชูโอ้สสอบตก ชูโอ้สก็คิดว่าตัวเองไม่มีอะไรดีเป็นคนขี้แพ้
        </div>
